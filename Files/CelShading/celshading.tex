...
for, at opnå dette ses i (\ref{shadeIntensity}).\\* \eq{12pt}{12pt}{0pt}{7pt}{shadeIntensity = ceil(intensity
* numShades)/numShades}{shadeIntensity}\eq{12pt}{12pt}{0pt}{7pt}{finalColor = baseColor * shadeIntensity}
{modulationbasecolor} 
\eq{12pt}{12pt}{0pt}{7pt}{shadeIntensity = ceil(intensity * numShades)/numShades} {shadeIntensity} 
\wrapfig{l}{0.25} {10em}{Files/CelShading/silhouette4.pdf} {} {fig:modulationbasecolor}
%\vspace*{425pt}
\\*
...
intensiteten.\eq{12pt}{12pt}{0pt}{7pt}{\kern -4cm  finalcolor = modelTexture * shadeIntensity}
...
\ref{fig:mixedmodulation}.\eq{12pt}{12pt}{0pt}{7pt}{\kern -6.5cm finalcolor = baseColor * modelTexture * shadeIntensity} {mixedmodulation}
\wrapfig{l}{0.25}{10em}{Files/CelShading/silhouette5.pdf}{} {fig:modulationofcolorfromteksture}
\wrapfig{r}{0.25}{10em}{Files/CelShading/silhouette6.jpg}{} {fig:mixedmodulation}
